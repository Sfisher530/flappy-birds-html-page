...
<head>
<meta charset="utf-8">
<title>Javascript and Canvas Games</title>
</head>
<Body>
...
<hgroup>
<h1 style="font-family:Lucida Console;">Games Made with Javascript</h1>
<h2 style="font-family:Courier New;">Flappy Birds Knock Off</h2>
</hgroup>
...
function startGame() {
    ...
    myScore = new component("30px", "Lucida Console", "Red", 280, 40, "text");
    myGameArea.start();
}
...
<p>Use the Accelerate button to avoid the pipes and stay alive as long as possible.</p>
<p>How long will you last?</p>
</body>
...
<small>Copyright &copy; w3schools.com</small>
